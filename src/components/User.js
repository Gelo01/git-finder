                ...
                <div className="container" style={{marginTop: '50px'}}>
                    ...
                    <div className="card">
                        <div className="card-body">
                            <h5 className="card-title">{this.state.user.login}'s GitHub Repositories</h5><hr/>
                            <div className="row">
                           
                            {repoData ?                          
                            repoData.map((repo,readme, i) => {                  
                                return (                                     
                                    <div className="col-lg-12" style={{marginBottom: "30px"}} key={i.toString()}>
                                        <div className="card">
                                            <div className="card-body"> 
                                                ...
                                                <div className="col-lg-4 col-md-12 col-sm-12">                                                     
                                                        <a href={repo.html_url} style={{float: 'right'}} className="btn btn-dark btn-sm">
                                                            <i className="fab fa-github"></i> source
                                                        </a>
                                                        <a href={"https://raw.githubusercontent.com/"+this.state.user.login+"/"+repo.name+"/master/README.md"} style={{float: 'right'}} className="btn btn-info btn-sm"
                                                        rel="noreferrer"
                                                        target="_blank">
